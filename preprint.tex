...
% -----------------------------------------------------------------------------
% Preprint build: no journal, volume, issue, DOI or publication date yet.
\journaltitle{}
\DOI{}
\copyrightyear{2026}
\pubyear{2026}
...
\subheading{Availability and implementation:} RapidMACS is open source under the MIT license at \url{https://github.com/morphic-bio/rapidmacs}, with both a standalone CLI executable (\texttt{rapidmacs}) and a linkable C++ library. Prebuilt containers for x86-64 and arm64 are published as \texttt{biodepot/rapidmacs} and \texttt{ghcr.io/\allowbreak morphic-bio/\allowbreak rapidmacs}.
