...
RapidMACS calls narrow peaks on paired-end fragments, with or without a matched input or IgG control. It does not support any other MACS3 subcommands. The narrow scope is sufficient for ATAC-seq and multiomic pipelines and the focus on narrow peak calling allowed us to optimise RapidMACS for this purpose. These improvements are described next. 
