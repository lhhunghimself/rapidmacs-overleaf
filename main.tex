...
\subheading{Availability and implementation:} RapidMACS is open source under the MIT license at \url{https://github.com/morphic-bio/rapidmacs}; the results reported here are from v1.0.1. It provides both a standalone CLI executable (\texttt{rapidmacs}) and a linkable C++ library. Prebuilt containers for x86-64 and arm64 are published as \texttt{biodepot/rapidmacs} on Docker Hub.
